...
<span style="display:none;">
	<input type="text" class="input-large span3" name="moduleId" id="moduleId" 
      	value="${module.moduleId }" placeholder="模块ID">
   
      <input type="text"   name="parentId" id="parentId" value="${module.parentId }" placeholder="父模块名">
...
<div class="form-group"  style="margin-top: 10px;">
   ...
   <div class="col-sm-3 controls">
      <input type="text" class="input-large span3" name="moduleName" id="moduleName" value="${module.moduleName }"
