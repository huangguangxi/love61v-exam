...
public class UserTest {
	...
	@Test public void getByIdTest(){
		SystemUser systemUser = systemUserService.getById("2B20499BA38B4981A59039845F2A0464", SystemUser.class);
	...
	@Test public void saveTest(){
		SystemUser systemUser = new SystemUser();
		systemUser.setUserId(UUIDutils.getUUID());
		systemUser.setLoginName("admin");
		systemUser.setPassword(Md5.md5("123"));
	...
	@Test public void saveBatchTest(){
		...
		for(int i = 10; i < 40; i++){
			...
			systemUser.setDeptId("111111111");
	...
	@Test public void deleteTest(){
		int count = systemUserService.delete("aa", SystemUser.class);
		print("删除" + count +"条数据");
	}
